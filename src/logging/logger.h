 ...
 * Responsibility: Centralized logging with file rotation, levels, and thread safety
 * Follows SRP: Only manages logging operations
 */
class Logger
{
public:
     ...
     * @param logFilePath Path to log file (default: logs/pix3lforge.log)
...
private:
    ...
    static constexpr const char* DEFAULT_LOG_FILE = "pix3lforge.log";
};
